...
export default function PrincipalDesk() {
  return (
    <div className="py-10 bg-slate-50 min-h-screen">
      ...
      {/* Banner in Electric Royal Blue Theme */}
      <section className="relative py-16 bg-slate-900 text-white overflow-hidden mb-12 rounded-b-[40px] shadow-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 mb-20">
        ...
        <section className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 sm:p-10 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-5 space-y-5">
              ...
              {/* Quote Card */}
              <div className="p-5 bg-blue-50/80 border border-blue-200 rounded-2xl space-y-2 text-center">
                <Quote className="h-6 w-6 text-blue-600 mx-auto opacity-70" />
                <p className="font-serif font-bold text-slate-900 text-sm italic leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-center">
                  <span className="font-bold text-xs text-blue-700 block">NAAC A+ & NBA</span>
                  <span className="text-[10px] text-slate-500 font-mono">Academic Status</span>
                </div>
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-center">
                  <span className="font-bold text-xs text-blue-700 block">R&D & Patents</span>
                  <span className="text-[10px] text-slate-500 font-mono">Innovation Labs</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              <div>
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold font-mono bg-blue-50 text-blue-700 border border-blue-200 uppercase tracking-wider mb-2">
                  <GraduationCap className="h-3.5 w-3.5 text-blue-600" /> Principal's Address
                </span>
              ...
              <div className="space-y-4 text-slate-700 text-sm sm:text-base leading-relaxed font-normal">
                <p className="p-4 bg-blue-50/70 rounded-2xl border-l-4 border-blue-600 font-medium text-slate-900">
                ...
                <div className="pt-2 text-blue-700 font-serif font-bold text-lg">
              ...
              <div className="pt-4 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-[10px] text-slate-400 font-mono uppercase font-bold block">Principal Desk Email:</span>
                    <a href="mailto:principal@recw.ac.in" className="font-mono font-bold text-xs text-blue-700 hover:underline">
                ...
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-[10px] text-slate-400 font-mono uppercase font-bold block">Campus Office Landline:</span>
